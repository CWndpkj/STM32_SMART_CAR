...
#define LIGHT_FIND_LEFT_GPIO_Port GPIOA
#define INFRARED_RIGHT_Pin GPIO_PIN_4
#define INFRARED_RIGHT_GPIO_Port GPIOA
#define LIGHT_FIND_RIGHT_Pin GPIO_PIN_5
#define LIGHT_FIND_RIGHT_GPIO_Port GPIOA
#define INFRARED_LEFT_Pin GPIO_PIN_6
#define INFRARED_LEFT_GPIO_Port GPIOA
